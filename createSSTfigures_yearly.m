...
for NumDatSet = [1 2]
    ...
    InformeAnho1=sprintf('Temperatura media en %s: %4.2fºC [%s].\n', ... 
    ...
    InformeAnho3=sprintf('Temperatura media: %4.2fºC, desviacion standart: %04.2fºC.\n', ...
        nanmean(MEstacionesSSTanualM(1:end-1)), ...
        nanstd(MEstacionesSSTanualM(1:end-1)));
    InformeAnho4=sprintf('Máxima [%s]: %4.2fºC. ',...
    ...
    InformeAnho5=sprintf('Mínima [%s]: %4.2fºC.',...
